...
class UserAdapter(private val retryCallback: () -> Unit) : PagedListAdapter<NewEpisodeRes.Data.Item, RecyclerView.ViewHolder>(UserDiffCallback) {
    ...
    companion object {
        val UserDiffCallback = object : DiffUtil.ItemCallback<NewEpisodeRes.Data.Item>() {
            override fun areItemsTheSame(oldItem: NewEpisodeRes.Data.Item, newItem: NewEpisodeRes.Data.Item): Boolean {
                return oldItem.id == newItem.id
            }

            override fun areContentsTheSame(oldItem: NewEpisodeRes.Data.Item, newItem: NewEpisodeRes.Data.Item): Boolean {
